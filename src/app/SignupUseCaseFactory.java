...
public class SignupUseCaseFactory {
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, ClearViewModel clearViewModel, ClearUserDataAccessInterface userDataAccessObject) throws IOException {
        ...
        ClearOutputBoundary outputBoundary = new ClearPresenter(viewManagerModel, clearViewModel);

        ClearInputBoundary inputBoundary = new ClearInteractor(userDataAccessObject, outputBoundary);

        return new ClearController(inputBoundary);
    }
}
